...
class MemoryTool(BaseTool):
    ...
    parameters = [
        ToolParameter(
            name="action",
            type="string",
            description="Memory operation: save, list, update, delete, search, or switch_user.",
            required=True,
        ...
        ToolParameter(
            name="category",
            type="string",
            description="Memory category (preference, named_entity, pattern, instruction, fact, observation).",
            required=False,
        ...
        ToolParameter(
            name="scope",
            type="string",
            description="Visibility scope: user, global, or agent.",
            required=False,
